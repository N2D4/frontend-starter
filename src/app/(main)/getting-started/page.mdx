...
>
  Sometimes, you may see some text that is using a handwriting font like this. <Typography display="inline" component="span">This is a safeguard to make sure you wrap all text in a component that supports Joy UI styling. Usually, you would use `<Paragraph body />` or `<Typography />` for this purpose.</Typography>
</Paragraph>
