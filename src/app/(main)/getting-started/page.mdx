...
Either click [this link](https://github.com/new?template_name=frontend-starter&template_owner=N2D4) (which directs you to the "Use this template" button on [our GitHub page](https://github.com/N2D4/frontend-starter)) or initialize it using npm:
